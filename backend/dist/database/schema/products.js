...
export const products = mysqlTable("products", {
    ...
    colorImages: json("color_images").$type().default({}),
    mediaType: varchar("media_type", { length: 20 }).default("image"),
    glbModelIds: json("glb_model_ids").$type().default([]),
    ...
    sizes: json("sizes").$type().default([]),
    tags: json("tags").$type().default([]),
    variantStock: json("variant_stock").$type().default({}),
