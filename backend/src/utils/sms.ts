 ...
 */
export async function sendSMS(phoneNumber: string, message: string): Promise<AfroSMSResponse> {
  try {
 ...
 * Send OTP SMS
 */
export async function sendOTPSMS(phoneNumber: string, otp: string): Promise<AfroSMSResponse> {
 ...
 * Send welcome SMS
 */
export async function sendWelcomeSMS(phoneNumber: string, name: string): Promise<AfroSMSResponse> {
  const appName = await getAppName();
 ...
 */
export async function sendPasswordResetOTPSMS(phoneNumber: string, otp: string): Promise<AfroSMSResponse> {
  const appName = await getAppName();
